...
from .dsc_kinetics import (
    ...
    detect_isothermal_event_candidates,
...
__all__ = [
    ...
    "preprocess_pipeline",
    # kinetics
    "AvramiResult", "IsothermalEventCandidate", "IsothermalSegment", "IsothermalKineticsResult",
    "NonIsothermalResult", "NonIsothermalCurve", "NonIsothermalKineticsSeries",
    "detect_isothermal_segments", "detect_isothermal_event_candidates",
    ...
    "avrami_fit", "avrami_from_dsc", "avrami_candidates_from_dsc",
    "MDSCResult", "deconvolve_mdsc", "deconvolve_mdsc_simple",
    "analyse_glass_transition_mdsc", "detect_enthalpic_relaxation",
    "POLYMORPH_DB", "TRANSITION_TYPES", "classify_transition",
    "detect_multistep_events", "correct_thermal_lag", "analyze_flash_heating",
    "analyze_flash_cooling", "critical_cooling_rate",
