...
_SAXS_STRAIN = ResultTableTemplate(
    ...
    primary_fields=(
        ...
        ResultFieldSpec(
            "q_peak_total_nm1",
            "TABLE_FIELD_TRACKED_Q_PEAK",
            "nm^-1",
            4,
        ),
        ResultFieldSpec(
            "L_meridional_nm",
            "TABLE_FIELD_MERIDIONAL_LONG_PERIOD",
            "nm",
            2,
        ),
        ResultFieldSpec(
            "q_peak_meridional_nm1",
            "TABLE_FIELD_MERIDIONAL_Q_PEAK",
            "nm^-1",
            4,
        ),
        ResultFieldSpec(
            "L_equatorial_nm",
            "TABLE_FIELD_EQUATORIAL_LONG_PERIOD",
            "nm",
            2,
        ),
        ResultFieldSpec(
            "q_peak_equatorial_nm1",
            "TABLE_FIELD_EQUATORIAL_Q_PEAK",
            "nm^-1",
            4,
        ),
        ResultFieldSpec(
            "feature_tracking_status",
            "TABLE_FIELD_FEATURE_TRACKING",
        ),
        ResultFieldSpec(
            "invariant_Q",
            "TABLE_FIELD_INVARIANT_Q",
            "a.u.",
            3,
            aliases=("Q_star", "Q_star_abs"),
        ),
        ResultFieldSpec(
            "invariant_Q_rel",
            "TABLE_FIELD_INVARIANT_Q_REL",
            digits=4,
            aliases=("Q_star_rel", "Q_rel"),
        ),
        ResultFieldSpec(
            "f_Herman",
            "TABLE_FIELD_HERMAN",
