...
- [x] **Step 2: Run the transport tests GREEN**
...
- [x] **Step 1: Implement a presentation-only formatter**
...
- [x] **Step 2: Run presentation tests GREEN**
...
- [x] **Step 1: Add focused consumer assertions**
...
- [x] **Step 2: Run the applicable SAXS matrix**
...
- [x] **Step 3: Update durable state and checkpoint**

Mark only verified acceptance items, list limitations, and run:

```powershell
python scripts/auto_commit.py --message "feat(saxs): surface series evidence in workbench" --files polynexus/core/saxs.py polynexus/gui/saxs_results_table_service.py tests/test_saxs_workbench_series_evidence.py docs/agent/tasks/2026-07-27-saxs-workbench-series-evidence-visibility.md docs/superpowers/plans/2026-07-27-saxs-workbench-series-evidence-visibility.md docs/agent/memory/active-work.md docs/agent/memory/current-state.md
```
